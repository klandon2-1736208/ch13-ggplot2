...
ggplot(data = diamonds) +
  stat_summary(mapping = aes(x = cut, y = depth), fun.y = "median", fun.ymin = "min", fun.ymax = "max")
...
ggplot(data = diamonds) +
  geom_bar(mapping = aes(x = clarity), position = "fill")
...
ggplot(data = diamonds) +
  geom_bar(mapping = aes(x = clarity), position = "dodge")
